...
//
// Create a new song, standalone or for the sample component:
//
//   curl http://localhost:7007/api/music-library/songs -H 'Content-Type: application/json' -d '{"title": "My Song"}'
//   curl http://localhost:7007/api/music-library/songs -H 'Content-Type: application/json' -d '{"title": "My Song", "entityRef": "component:default/sample"}'
//
// List Songs:
//
//   curl http://localhost:7007/api/music-library/songs
//
// Explicitly make an unauthenticated request, or with service auth:
//
//   curl http://localhost:7007/api/music-library/songs -H 'Authorization: Bearer mock-none-token'
//   curl http://localhost:7007/api/music-library/songs -H 'Authorization: Bearer mock-service-token'
